...
s:
    ...
    if(n==1)
        ...
        {
d:          if(o==p&&q>m||o==p&&q==m&&m>0||o==p&&m>q)
            {
                f++;
                y[0]=z[0];
                y[1]=z[1];
            ...
            m++;
            if(o==95&&n==0){y[0]='9';y[1]='5';}
            else if(o==97&&n==0){y[0]='9';y[1]='7';}
            else if(o==99&&n==0){y[0]='9';y[1]='9';}
            else if(f==0)
            {
                y[1]=a[box[o]];
                y[0]=a[box[o]-1];
        ...
        {
c:          if(p==o&&m>q||p==o&&m==q&&q>0||p==o&&q>m)
            {
                g++;
                z[0]=y[0];
                z[1]=y[1];
            ...
            q++;
            if(p==95&&n==0){z[0]='9';z[1]='5';}
            else if(p==97&&n==0){z[0]='9';z[1]='7';}
            else if(p==99&&n==0){z[0]='9';z[1]='9';}
            else if(g==0)
            {
                z[1]=a[box[p]];
                z[0]=a[box[p]-1];
            ...
            if(p==4) {p=23;n=19;goto c;}
            else if(p==7) {p=12;n=5;goto c;}
            else if(p==15) {p=72;n=57;goto c;}
            else if(p==30) {p=52;n=22;goto c;}
            else if(p==36) {p=41;n=5;goto c;}
            else if(p==61) {p=82;n=21;goto c;}
            else if(p==66) {p=77;n=11;goto c;}
            else if(p==90) {p=93;n=3;goto c;}
            else if(p==28) {p=10;n=-18;goto c;}
            else if(p==39) {p=18;n=-21;goto c;}
            else if(p==55) {p=45;n=-10;goto c;}
            else if(p==70) {p=49;n=-21;goto c;}
            else if(p==79) {p=56;n=-23;goto c;}
            else if(p==96) {p=33;n=-63;goto c;}
            else if(p==98) {p=60;n=-38;goto c;}
            if(p==100||o==100)
                return o;
            n=Random(1,6);
            getchar();
